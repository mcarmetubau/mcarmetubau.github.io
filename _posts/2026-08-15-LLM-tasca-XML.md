...
Abans de fer el lliurament, heu de comprovar la validesa del document resultant a [XML Validation](https://www.xmlvalidation.com/?L=0).
...
![Llista empleats](../assets/img/mostra_csv.png).
...
![Estructura arbre XML](../assets/img/EstructuraDBLAN.jpg).
